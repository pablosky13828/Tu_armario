...
<html>
	...
	<body>
		...
		<div class="container-fluid">
			...
			<div>
				<!--FOMR-->
				<form action="recoverPassword2.php" method="GET">
					<table class="logInRegister-marcos" align="center">
						<tr><td class="logInRegister-box">
							<p class='txt'>
								Email: <br>
								<input id="email" type="text" data-sb-validations="required" style="width:100%"/>
							</p>
							
							<br>
							
							<div style='text-align:center'>
									<input type="submit" value="CONTINUAR" class="logInRegister-boton" name='recPassword'/>
							</div>
							
							<p> 
								<br>
								<a class="txt-min red" href="register.php">No tienes cuenta... Registrate!</a><br>
								<a class="txt-min red" href="logIn.php">Ya recuerdas la contraseña... Inicia Sesión!</a> 
							</p>
						</td></tr>
					</table>
				</form>
