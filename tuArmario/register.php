...
<html>
	...
	<head>
		...
		<!--Title--> 
		<title>Registro - tuArmario.es</title>
		<meta charset="UTF-8">
	...
	<body>
		...
		<div class="container-fluid">
			...
			<!-- Title -->
			<div>
				<h4 class="display-5 txt-title">REGISTER</h4>
							...
							<tr>
								<td class="logInRegister-box">
									<p class='txt'>
										...
										Confirm Password:<br>
										<input id="confpassword" type="text" data-sb-validations="required" class="logInRegister-rellenar" name='confPassW'/>
									</p>
									
									<br>
									<div style="text-align:center">
										<input type="submit" value="REGISTER" class="logInRegister-boton"/>
									</div>
									
									<p> 
										<br>
										<a class="txt-min red" href="recoverPassword.php">Olvidaste tu contraseña?</a><br>
										<a class="txt-min red" href="logIn.php">Ya tienes cuenta... Inicia Sesión!</a> 
									</p>
								</td>
							</tr>
						</table>
